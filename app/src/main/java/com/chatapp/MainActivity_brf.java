...
public class MainActivity_brf extends Activity implements View.OnClickListener {

    private TextView content,receiver;
    private EditText msg;
    private ImageButton send;
    private static final String uri = "ws://182.92.2.234:9000/chatWebSocket/brf/tqq";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_brf);
        ...
        URI uri = null;
        try {
            uri = new URI(MainActivity_brf.uri);
...
//        socketClient.connect();
    ...
    public void onClick(View v) {
        if (v.getId()==send.getId()){
            try {
                recevieContent("brf："+msg.getText().toString());
